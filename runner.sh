...
check_last_command
tmux send-keys -t whisper "cd $(pwd)/whisper && conda activate whisper_env && gunicorn server:app --workers 4 --worker-class uvicorn.workers.UvicornWorker --bind 0.0.0.0:9004" C-m
